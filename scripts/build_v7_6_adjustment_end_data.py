#!/usr/bin/env python3
"""Build V7.6 magnitude-counterfactual adjustment-end artifacts."""
...
from tactile_vla.vla.v7_6_adjustment_end_data import artifact_hash_payload
from tactile_vla.vla.v7_6_adjustment_end_data import build_adjustment_end_artifacts
...
DEFAULT_OUTPUT = DEFAULT_ROOT / "outputs/rotation_v7_6_adjustment_end_counterfactual_h100"
...
def main() -> int:
    ...
    if args.dry_run:
        print("dry_run=true; no V7.6 files were written")
        return 0
    ...
    _write_json(
        ...
        artifact_hash_payload({name: paths[name] for name in ("manifest", "index", "summary")}),
    )
    print(f"wrote V7.6 adjustment_end artifacts to {args.output_dir}")
    return 0
