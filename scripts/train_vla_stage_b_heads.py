...
DEFAULT_BACKBONE_CHECKPOINT = Path(
    "/data1/outputs/vla/stage_a_action/pi05_delta_tac_h30_state_memory_expanded/10000"
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--run-name", default="pi05_heads_jax_h30_state_memory_expanded")
